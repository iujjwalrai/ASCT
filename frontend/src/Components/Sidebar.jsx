...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar / Navbar */}
      <div
        className={`md:flex flex-col md:w-[20%] bg-gradient-to-t from-blue-900 to-purple-800 text-white h-full py-4 rounded-3xl mx-3 my-3 md:h-full absolute md:static transition-transform duration-300 ${
