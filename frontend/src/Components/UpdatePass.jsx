...
const UpdatePass = () => {
  ...
  return (
    <div className='flex bg-gradient-to-tl from-blue-500 via-purple-400 to-white gap-16'>
        <Sidebar/>
        <div className='mt-16 w-[70vw] max-w-[90vw] bg-blue-100 h-[85vh] shadow-2xl shadow-black rounded-3xl px-16 py-8'>
            ...
            <div className='flex justify-center py-8'>
                <form className='flex flex-col w-[80%] gap-6 shadow-red-400 shadow-xl rounded-2xl  px-5 py-10' onSubmit={handleSubmit(updateHandler)}>
