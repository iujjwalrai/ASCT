    ...
    <div className="flex flex-col md:flex-row bg-gradient-to-tl from-blue-500 via-purple-400 to-white gap-6 relative min-h-screen md:items-start">
      ...
      <div className="mt-16 w-full md:w-[70vw] max-w-[95vw] bg-blue-100 shadow-2xl shadow-black rounded-3xl px-16 py-8 mx-auto">
        <h1 className="text-2xl font-semibold">
          Welcome {user.name}!! Your details are as follows{" "}
        </h1>
        <h2 className="mt-5 text-2xl text-red-600 text-center font-bold">
          Basic Details
        </h2>
        <div className="mt-8 flex md:flex-row flex-col gap-y-1 md:justify-between text-lg text-blue-950 font-semibold">
          <p className="border-2 border-red-700 min-w-[40%] text-center">
            Name: {user.name}
          </p>
          <p className="border-2 border-red-700 min-w-[20%] text-center">
            Reg No: {user.RegNo}
          </p>
          <p className="border-2 border-red-700 min-w-[30%] text-center">
            Email: {user.email}
          </p>
        </div>
        <div className="mt-8 flex md:flex-row flex-col gap-y-1 md:justify-between text-lg text-blue-950 font-semibold">
        ...
        <div className="mt-8 flex md:flex-row flex-col gap-y-1 md:justify-between text-lg text-blue-950 font-semibold">
          <p className="border-2 border-red-700 min-w-[15%] text-center">
            COPNo: {user.COPNo}
          </p>
          <p className="border-2 border-red-700 min-w-[20%] text-center">
            COP No Year: {user.COPNoYear}
          </p>
          <p className="border-2 border-red-700 min-w-[20%] text-center">
            Reg No Year: {user.RegNoYear}
          </p>
        </div>
        <h2 className="mt-5 text-2xl text-red-600 text-center font-bold">
          Practice Details
        ...
        <div className="mt-5 flex md:flex-row flex-col gap-y-1 md:justify-between text-lg text-blue-950 font-semibold">
          <p className="border-2 border-red-700 min-w-[35%] text-center ">
            Practice district: {user.Jila}
          </p>
          <p className="border-2 border-red-700 min-w-[25%] text-center">
            Teshil: {user.Tehsil}
          </p>
          <p className="border-2 border-red-700 min-w-[35%] text-center">
            Practice Level: {user.AdPractice}
          </p>
        </div>
        <h2 className="mt-5 text-2xl text-red-600 text-center font-bold">
          Other Details
        ...
        <div className="mt-5 flex md:flex-row flex-col gap-y-1 md:justify-between text-lg text-blue-950 font-semibold">
          ...
          <p className="border-2 border-red-700 min-w-[35%] text-center">
            Home District: {user.HomeDistrict}
          </p>
        </div>
        <div className="mt-5 flex justify-between text-lg text-blue-950 font-semibold">
          <p className="border-2 border-red-700 min-w-[100%] text-center">
        ...
        <div className="text-red-600 text-center text-2xl font-semibold mt-5">
          Want to Edit Your Details ?? Click below to do
        </div>
        <button
          className="py-2 w-full mt-10 bg-yellow-600 rounded-lg text-lg text-white hover:bg-yellow-400 hover:text-black duration-200 transition-all"
          onClick={openPopUp}
        >
          Edit Details
        </button>
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSubmit(submitHandler)}>
              <div className="flex md:flex-row flex-col gap-y-3 md:justify-between mt-3">
                <div>
                  ...
                  <input
                    ...
                    disabled
                    id="name"
                    className="bg-gray-400 px-4 py-2 rounded-xl mt-2"
                  ></input>
                </div>
                <div>
                  <label htmlFor="cop" className="block text-red-600 font-bold">
                    COP No. *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="reg" className="block text-red-600 font-bold">
                    Reg No. *
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="mob" className="block text-red-600 font-bold">
                    Mobile No. *
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex md:flex-row flex-col gap-y-3 md:justify-between mt-3">
                <div>
                  ...
                  <input
                    type="text"
                    id="email"
                    className="bg-gray-200 px-4 py-2 rounded-xl mt-2"
                    {...register("email")}
                  ></input>
                </div>
                <div>
              ...
              <div className="flex md:flex-row flex-col gap-y-3 md:justify-between mt-3">
                <div>
                  <label htmlFor="dis" className="block text-red-600 font-bold">
                    District *
                  </label>
                  <select
                    className="bg-gray-200 px-4 py-2 rounded-xl mt-2"
                ...
                <div>
                  <label htmlFor="teh" className="block text-red-600 font-bold">
                    Tehsil *
                  </label>
                  <select
                    className="bg-gray-200 px-4 py-2 rounded-xl mt-2"
                ...
                <div>
                  <label htmlFor="hd" className="block text-red-600 font-bold">
                    Home District *
                  </label>
                  <select
                    className="bg-gray-200 px-4 py-2 rounded-xl mt-2"
              ...
              <div>
                <div className="mt-2">
                  <label htmlFor="ha" className="block text-red-600 font-bold">
                    Enter the Home Address *
                  </label>
                  <input
                    type="text"
                    placeholder="Enter the home address"
                    className="w-[95%] bg-gray-200 px-4 py-2 rounded-xl mt-2"
                    id="ha"
              ...
              <div>
                <div className="mt-2">
                  <label
                    ...
                    className="block text-red-600 font-bold"
                  >
                    Enter the Disease and description (if any)
                  </label>
                  <input
                    type="text"
              ...
              <button
                className="bg-blue-900 text-white py-4 px-4 rounded-3xl w-full mt-10 hover:bg-blue-500 duration-200 text-lg font-bold"
                type="submit"
              >
                Update Details
              </button>
