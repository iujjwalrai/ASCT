...
const Card = ({head, desc}) => {
  return (
    <div className='bg-gradient-to-r from-gray-900 via-indigo-900 to-black p-8 hover:shadow-2xl hover:shadow-blue-800 hover:scale-105 transition duration-300 ease-in-out md:w-[40vw] rounded-3xl text-white pb-16 w-[80vw]'>
